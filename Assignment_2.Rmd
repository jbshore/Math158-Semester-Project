...
ggplot(housing2)+geom_point(aes(x = sqft_living, y = price)) + labs(xlab = 'sq. ft. living space', ylab = "Price", title = "Standard model for price vs. sq. ft. living space")
...
geom_point() +
geom_hline(yintercept = 0) + labs(xlab = "Fitted", ylab = "Std. Resid.", title = "Standardized Residual Plot")
...
geom_point() +
geom_smooth(method="lm", se=FALSE) + labs(xlab = 'Log(sq. ft. living space)', ylab = "Log(price)", title = "Power model for price vs. sq.ft. living space")
