...
legend(1700000,1100000,c("OLS(final)", "OLS(full)", "Ridge Reg.", "LASSO"), lty=c(1,1,1,1), lwd=c(2.5,2.5,2.5,2.5),col=c("black", "orange", "red", "blue"), cex = .62)
...
legend(6000,2000000,c(3,5,10,40), lty=c(1,1), lwd=c(2.5,2.5),col=c(1,2,3,4), title = "# Knots", cex = .52)
```
...
legend(6000,2000000,c(.1,.3,.6,.9), lty=c(1,1), lwd=c(2.5,2.5),col=c(1,2,3,4), title = "Span", cex = .52)
...
legend(47.2,3000000,c(3,5,10,40), lty=c(1,1), lwd=c(2.5,2.5),col=c(1,2,3,4), title = "# Knots", cex=.65)
```
...
legend(47.2,3000000,c(.1,.3,.6,.9), lty=c(1,1), lwd=c(2.5,2.5),col=c(1,2,3,4), title = "Span",cex=.5)
```
...
plot(full.model$coefficients, ylab = "Coeff. Value")
